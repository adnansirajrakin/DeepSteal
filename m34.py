...
from resnet2 import RESNET18,RESNET34
...
net_f = RESNET34(num_classes=10, pretrained=False)
...
'''
perc = torch.tensor([0.3125,0.0625,0.0625,0.0625,0.0875,0.1,0.125])
cc = 0
for name, module in adv_classifier.named_modules():
    if isinstance(module, nn.Linear) or isinstance(module, nn.Conv2d):
        ...
        if cc < args.layer:
            ...
            print(recordf[cc].size()[0]/tot,recordf[cc].size()[0]/tot,record7[cc].size()[0]/tot,record6[cc].size()[0]/tot,record5[cc].size()[0]/tot,record4[cc].size()[0]/tot,record3[cc].size()[0]/tot,record2[cc].size()[0]/tot,record[cc].size()[0]/tot)
